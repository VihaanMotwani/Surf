...
class ZepMemory:
    ...
    def __init__(self):
        ...
        self.user_id = os.environ.get("ZEP_USER_ID", "surf_local_user")
        self.user_name = os.environ.get("ZEP_USER_NAME", "User")
    ...
    def add_message(self, role: str, content: str, name: Optional[str] = None) -> None:
        ...
        try:
            ...
            print(f"[Memory] Error adding message: {e}")
    ...
    def store_browser_result(self, task: str, result: str, success: bool) -> None:
        ...
        try:
            ...
            print(f"[Memory] Error storing browser result: {e}")
    ...
    def add_user_preference(self, preference: str) -> None:
        ...
        try:
            ...
            print(f"[Memory] Error adding preference: {e}")
